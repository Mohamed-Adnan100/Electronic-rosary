...
# 31 "ECU_layer/7_segment/../../MCAL_Layer/GPIO/../MCAL_std_types.h"
...
# 3 "ECU_layer/7_segment/ecu_seven_segment.c" 2
...
Std_ReturnType seven_segment_intailize(const segment_t *segment){
    ...
    if( ((void*)0) == segment ){
        ...
        ret = gpio_pin_intailize(&(segment->segment_pins[0]));
        ret = gpio_pin_intailize(&(segment->segment_pins[1]));
        ret = gpio_pin_intailize(&(segment->segment_pins[2]));
        ret = gpio_pin_intailize(&(segment->segment_pins[3]));
    }
