...
Std_ReturnType gpio_pin_git_direction_status(const pin_config_t *pin_config, direction_t *direction){
    ...
    if( ((void*)0) == pin_config || ((void*)0) == direction || pin_config->pin > 8 -1){
        ...
        *direction = ((*tris_regesters[pin_config->port] >> pin_config->pin) & (uint8)1 );
    }
    return ret;
}
...
# 100 "MCAL_Layer/GPIO/HAL_gpio.c"
Std_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config, logic_t *logic){
    Std_ReturnType ret = (Std_ReturnType)0X01;
    if( ((void*)0) == pin_config || ((void*)0) == logic || pin_config->pin > 8 -1){
        ...
        *logic = ((*port_regesters[pin_config->port] >> pin_config->pin) & (uint8)1 );
    }
    return ret;
}
...
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t *pin_config){
    ...
    if( ((void*)0) == pin_config || pin_config->pin > 8 -1){
        ret = (Std_ReturnType)0X00;
         ...
         (*port_regesters[pin_config->port] ^= ((uint8)1 << pin_config->pin));
    }
    return ret;
...
Std_ReturnType gpio_port_git_direction_status( port_index_t port_index, uint8 *direction){
    Std_ReturnType ret = (Std_ReturnType)0X01;
    if( (((void*)0) == direction) && (port_index > 8 -1)){
        ret = (Std_ReturnType)0X00;
    }
    else{
...
Std_ReturnType gpio_port_read_logic( port_index_t port_index, uint8 *logic){
    Std_ReturnType ret = (Std_ReturnType)0X01;
    if(( ((void*)0) == logic) && (port_index > 8 -1)){
        ret = (Std_ReturnType)0X00;
    }
    else{
